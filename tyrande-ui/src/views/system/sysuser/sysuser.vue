  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      <el-table border :data="gridData.list">
        ...
        <el-table-column prop="sex" label="性别 1-男 2-女"/>
        <el-table-column prop="age" label="年龄"/>
        <el-table-column prop="avatar" label="头像"/>
        <el-table-column prop="address" label="地址"/>
        <el-table-column prop="email" label="邮箱"/>
        <el-table-column prop="validEmail" label="邮箱是否验证 0-否 1-是"/>
        <el-table-column prop="tel" label="电话"/>
        <el-table-column prop="validTel" label="电话是否验证 0-否 1-是"/>
        <el-table-column prop="status" label="用户状态 0-未使用 1-正常 2-锁定 3-过期"/>
    ...
    <el-dialog :title="defaultSettings.btnView" :visible.sync="visibleConfig.view" width="50%">
          <span>
            <el-form :model="viewForm" label-width="120px" disabled>
                ...
                <el-input v-model="viewForm.password"/>
              </el-form-item>
    ...
    <el-dialog :title="defaultSettings.btnAdd" :visible.sync="visibleConfig.add" width="50%"
          ...
          <span>
            <el-form :model="addForm" :rules="checkRules" ref="addFormRef" label-width="120px">
                 <el-form-item label="登陆账户" prop="loginCode">
                <el-input v-model="addForm.loginCode"></el-input>
              </el-form-item>
                 <el-form-item label="密码" prop="password">
                ...
                <el-input v-model="addForm.email"></el-input>
                 ...
                 <el-form-item label="邮箱是否验证 0-否 1-是" prop="validEmail">
                <el-input v-model="addForm.validEmail"></el-input>
              </el-form-item>
                 <el-form-item label="电话" prop="tel">
                <el-input v-model="addForm.tel"></el-input>
              </el-form-item>
                 <el-form-item label="电话是否验证 0-否 1-是" prop="validTel">
                <el-input v-model="addForm.validTel"></el-input>
              </el-form-item>
                 <el-form-item label="用户状态 0-未使用 1-正常 2-锁定 3-过期" prop="status">
    ...
    <el-dialog :title="defaultSettings.btnEdit" :visible.sync="visibleConfig.edit" width="50%"
          ...
          <span>
            <el-form :model="editForm" :rules="checkRules" ref="editFormRef" label-width="120px">
                   <el-form-item label="登陆账户" prop="loginCode">
                 <el-input v-model="editForm.loginCode"></el-input>
               </el-form-item>
                   <el-form-item label="密码" prop="password">
                 ...
                 <el-input v-model="editForm.email"></el-input>
                   ...
                   <el-form-item label="邮箱是否验证 0-否 1-是" prop="validEmail">
                 <el-input v-model="editForm.validEmail"></el-input>
               </el-form-item>
                   <el-form-item label="电话" prop="tel">
                 <el-input v-model="editForm.tel"></el-input>
               </el-form-item>
                   <el-form-item label="电话是否验证 0-否 1-是" prop="validTel">
                 <el-input v-model="editForm.validTel"></el-input>
               </el-form-item>
                   <el-form-item label="用户状态 0-未使用 1-正常 2-锁定 3-过期" prop="status">
