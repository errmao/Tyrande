  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="username">
        ...
        <el-input ref="username" v-model="loginForm.username" placeholder="登录账户" name="username" type="text" tabindex="1"
          auto-complete="on" />
      </el-form-item>
      ...
      <el-form-item prop="password">
        ...
        <el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType" placeholder="登录密码"
